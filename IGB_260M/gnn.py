...
class IGL260MDataset(object):
    ...
    def paper_feat(self) -> np.ndarray:
        ...
        node_features = np.memmap(path, dtype='float32', mode='r',  shape=(157675969+111005234,1024))
    ...
    def paper_label(self) -> np.ndarray:
        ...
        node_features = np.memmap(path, dtype='float32', mode='r',  shape=(157675969+111005234))
        return node_features
        # if self.in_memory:
        #     return np.load(path)
        # else:
...
class IGL260M(DGLDataset):
    ...
    def process(self):
        ...
        n_train = int(157675969 * 0.6)
        n_val = int(157675969 * 0.2)
        ...
        test_mask[n_train + n_val:157675969] = True
