...
# python gnn.py --modelpath gcn_2983.pt --batch_size 2048 --num_classes 2983 --model gcn > gcn_2983.txt & timeout 30m nvidia-smi dmon -i 2 > gcn_2983_gpu_stats.txt;
# wait
...
# python gnn.py --modelpath gsage_2983.pt --batch_size 2048 --num_classes 2983 --model sage > gsage_2983.txt & timeout 30m nvidia-smi dmon -i 2 > gsage_2983_gpu_stats.txt;
# wait
...
# python gnn.py --modelpath gat_2983.pt --batch_size 2048 --num_classes 2983 --model gat > gat_2983.txt & timeout 30m nvidia-smi dmon -i 2 > gat_2983_gpu_stats.txt;
